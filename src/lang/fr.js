...
var PROPERTY_SCRFAST = 'Mouvements aléatoires pour les mélanges de 4x4x4 (plus rapide mais non-officiel)';
var PROPERTY_SCRKEYM = 'Marquer les mouvements clé dans les mélanges';
var PROPERTY_WNDSCR = 'Style d\'affichage du panneau de mélange';
var PROPERTY_WNDSTAT = 'Style d\'affichage du panneau de statistiques';
var PROPERTY_WNDTOOL = 'Style d\'affichage du panneau d\'outils';
...
var STATS_SSMGR_ORDER = 'Ordonner par mélange';
var STATS_SSMGR_ODCFM = 'Ordonner toues les sessions par type de mélange?';
...
var STATS_STRING = 'Meilleure|En cours|Moins bonne|Généré par csTimer le %Y-%M-%D|Résolutions/Total: %d|Résolution|Moyenne sur %mk|Moyenne élaguée sur %mk|Moyenne élaguée: %v{ (σ = %sgm)}|Moyenne: %v|Liste des temps:|résolutions de %s à %e|Totally spent: %d';
